...
# library(extrafont)
# #font_import()       # First time only — scans system fonts
...
showtext_opts(dpi = 300)   # ??? match ggsave()'s default dpi
showtext_auto()
...
title <-"YouTube SEO on the Rise"
sub <- NULL
caption <- "\nSource: Google Search Data, Global June 2021- May 2025 \n https://github.com/papageorgiou/posts/tree/master/youtube-trends-seo |  @alex_papageo "
...
```{r}
ggsave("roboto_google_dpi.png", height = 5, width = 8) 
